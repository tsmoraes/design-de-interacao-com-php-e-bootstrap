    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form method="post" action="">
                ...
                <input name="enviar" class="btn btn-warning" type="button" onclick="location='gerentes.php'" value="Voltar"></td></tr>
                </table>
            </form>
        </div>
    <div>
...
if(isset($_POST['enviar'])){
    ...
    $sql = "UPDATE $tbl_gerentes SET nome = :nome, cpf=:cpf, rg=:rg, endereco=:endereco, estado=:estado WHERE id = :id";
    $sth = $pdo->prepare($sql);
   ...
   if($sth->execute()){
        print "<script>alert('Registro alterado com sucesso!');location='gerentes.php';</script>";
    }else{
