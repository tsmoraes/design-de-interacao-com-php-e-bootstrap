...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <table class="table table-striped table-dark table-responsive table-hover">    
        <form method="post" action="addFuncionarios.php">           
          ...
          <tr><td>Função</td><td><input type="text" name="funcao"></td></tr>
  ...
  if(isset($_POST['enviar'])){
    ...
    try{
     $stmte = $pdo->prepare("INSERT INTO funcionarios(nome,cpf,rg,endereco,estado,funcao) VALUES (?, ?, ?, ?, ?, ?)");
     ...
     $stmte->bindParam(6, $funcao , PDO::PARAM_STR);
