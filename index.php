...
<nav class="navbar navbar-expand-lg navbar-primary bg-dark">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <a href="addFuncionarios.php" class="btn btn-primary">Adicionar</a>
    </div>
  </div>
</nav>
<br>
...
try{
  $stmte = $pdo->query("SELECT * FROM $tbl_funcionarios order by nome");
  $executa = $stmte->execute();
  ?>
  <div class="container">
    <h1>Funcionários</h1>
    <table align="center" class="table table-striped table-dark table-responsive table-hover">
      <caption>CRUD de Funcionários</caption>
      <tr><td><b>Nome</td><td><b>CPF</td><td><b>RG</td><td><b>Endereço</td><td><b>UF</td><td><b>Função</td><td colspan="2" align="center">Opções</td></tr>
        ...
        while($reg = $stmte->fetch(PDO::FETCH_OBJ)){ // Para recuperar um ARRAY utilize PDO::FETCH_ASSOC 
          ...
          <tr>
            ...
            <td><?=$reg->estado?></td>
            <td><?=$reg->funcao?></td>
            <td><a href="updateFuncionario.php?id=<?=$reg->id?>">Editar</a></td>
            <td><a href="deleteFuncionario.php?id=<?=$reg->id?>">Excluir</a></td></tr>
            <?php
          }
          print '</table>';
          print '</div>';
